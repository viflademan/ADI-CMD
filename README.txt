Version 1.0.1 of Alternative Daz Importer by raldios
...
Bugs
	If you encounter any bugs, use debug.bat instead of ADI.exe to keep the error on screen. Please describe the error on the discord in #bugs-and-help.
